      ...
      <div style={{ padding: '22px 16px 0' }}>
        <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 14 }}>
          <h2 style={{ fontSize: 17, fontWeight: 800, color: '#191F28', letterSpacing: '-0.02em' }}>
            {hasPetProfile ? `🎯 ${petName}에게 맞춤 추천` : '🏆 인기 상품'}
          </h2>
        ...
        {topRanked.length === 0 ? (
          <div style={{ background: '#fff', borderRadius: 16, padding: 20, textAlign: 'center', color: '#B0B8C1' }}>
            <div style={{ fontSize: 28, marginBottom: 8 }}>⏳</div>
            <p style={{ fontWeight: 600, fontSize: 14 }}>상품을 불러오는 중...</p>
          </div>
        ) : (
