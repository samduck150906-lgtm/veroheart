...
export const ANIMAL_FAMILY_FIXTURE_CASES: AnimalFamilyFixtureCase[] = [
  ...
  { id: 'chicken-fat', family: 'chicken', allergyLabel: '닭', ingredientName: '닭지방', shouldHitFamilyAllergy: true, note: 'named fat' },
  { id: 'poultry-byproduct', family: 'chicken', allergyLabel: '닭', ingredientName: '가금류부산물', shouldHitFamilyAllergy: true, note: 'poultry family review' },
