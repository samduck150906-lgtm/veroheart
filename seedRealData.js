...
async function run() {
  ...
  const mappings = {
    '00000000-0000-0000-0000-000000000201': ['쌀', '계육분', '옥수수', '현미', '닭 지방'], // missing 옥수수, 현미 from array above? wait, they might be in DB from previous seed. Let's just insert.
    '00000000-0000-0000-0000-000000000202': ['닭 신선육', '칠면조 신선육', '가다랑어', '연어'],
    '00000000-0000-0000-0000-000000000203': ['건조 감자', '오리분말', '생오리', '유채유'],
    '00000000-0000-0000-0000-000000000204': ['닭고기', '쌀', '옥수수 글루텐', '가공 가금류 육분'], // missing 가공 가금류 육분 in previous seed? We added it.
