...
export function PhoneMockup({ children, label }: Props) {
  return (
    ...
    >
      <div className="rounded-[2.25rem] border-[10px] border-forest-800 bg-forest-900 p-1 shadow-soft">
        <div className="relative overflow-hidden rounded-[1.85rem] bg-cream-50">
          <div className="absolute left-1/2 top-2 z-10 h-5 w-20 -translate-x-1/2 rounded-full bg-forest-900/90" />
          {label && (
