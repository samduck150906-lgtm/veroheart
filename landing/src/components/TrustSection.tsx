    ...
    >
      <div className="mx-auto max-w-6xl px-5 sm:px-6">
        ...
        <div className="grid gap-10 lg:grid-cols-[1fr_1.1fr] lg:gap-16">
          <Reveal>
            <ul className="grid gap-3 sm:grid-cols-2">
              {BASIS_ITEMS.map((item) => (
                <li
                  key={item}
                  className="flex items-center gap-3 rounded-xl border border-ink-800/10 bg-white px-4 py-3.5"
                >
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-gold-soft text-gold-darkest">
          ...
          <Reveal delayMs={80}>
            <div className="rounded-2xl border border-ink-800/10 bg-white p-6 sm:p-7">
              <h3 className="text-sm font-bold text-ink-900">이렇게 판단해요</h3>
              ...
              <div className="mt-5 rounded-xl bg-cream-50 p-4">
                ...
                <p className="mt-1.5 text-sm leading-relaxed text-ink-800/85">
